...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision) {
        ...
        //        AttackConsumer consumer = collision.gameObject.GetComponent<AttackConsumer>();
        //        if (!consumer) {
        //            Debug.LogError("Collider was tagged Enemy but does not have an AttackConsumer " + collision.gameObject.name);
        //            return;
        //        }
        //        if (!movementController.IsGrounded) consumer.ReceiveAttack(AttackType.Jump, collision.contacts[0].point);
        //    }
    }
}